...
heart_boost2 = gbm(AHD_num~., data=heart[train,], distribution="bernoulli", n.trees=5000, shrinkage=0.001, interaction.depth=2, cv.folds=10, class.stratify.cv=T)
...
heart_boost3 = gbm(AHD_num~., data=heart[train,], distribution="bernoulli", n.trees=5000, shrinkage=0.01, interaction.depth=1, cv.folds=10, class.stratify.cv=T)
...
heart_boost4 = gbm(AHD_num~., data=heart[train,], distribution="bernoulli", n.trees=5000, shrinkage=0.01, interaction.depth=2, cv.folds=10, class.stratify.cv=T)
...
heart_xgb <- caret::train(AHD_num~., data=heart[train,], method="xgbTree", trControl=train_control, tuneGrid=tune_grid, verbosity = 0)
...
caret::RMSE(heart[test, "AHD_num"], yhat_xgb)
```
