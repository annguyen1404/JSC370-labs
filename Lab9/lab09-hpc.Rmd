...
- Cross validation in ML (packages: carat, mlr)
...
fun1alt <- function(n = 100, k = 4, lambda = 4) {
  matrix (rpois(n*k, lambda=lambda))
}
...
How much faster? fun1alt() is significantly faster than fun1()
...
I expect the process that's across 4 GPUs to be faster than across 2 GPUs and 1 GPU.
